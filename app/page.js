            ...
            {venues.map((venue, index) => (
              ...
              >
                <Card className="h-full shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                  ...
                  <div className="p-6">
                    <h3 className="font-bold text-xl mb-3 text-gray-900">{venue.name}</h3>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Button className={`bg-gradient-to-r ${venue.color} hover:scale-105 transition-transform text-white`}>
                        Book Now
                      </Button>
                    </div>
                  </div>
